...
[![Testes](https://img.shields.io/badge/testes-312%20passando-3FB950)](docs/SECURITY-TEST-REPORT.md)
...
**Pentests adversariais** sobrevividos e **312 testes** automatizados sustentam o produto (eram 176 no corte do 1.0.0; subiram com release assinado, selo de proveniência, lista de redação e o cofre cifrado para destinatário X25519).
